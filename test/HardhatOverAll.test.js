...
const Artion = artifacts.require('DigiBirrAssets');
...
contract('Overall Test',  function ([owner, platformFeeRecipient, artist, buyer, bidder1, bidder2, bidder3])  {
    ...
    beforeEach(async function () {
        ...
        this.nfthab = await Artion.new(platformFeeRecipient, platformFee);
        ...
        await this.fantomAddressRegistry.updateArtion(this.nfthab.address);
    ...
    describe('Minting and auctioning NFT', function() {
        ...
        it('Scenario 1', async function(){
            ...
            let balance = await this.nfthab.platformFee();
            console.log(`
            ...
            console.log(`
            Now minting...`);
            let result = await this.nfthab.mint(artist, 'http://artist.com/art.jpeg', {from: artist, value: ether(PLATFORM_FEE)});
            console.log(`
            Minted successfully`);
            ...
            *Event Minted should be emitted with correct values: 
            ...
            await this.nfthab.setApprovalForAll(this.fantomMarketplace.address, true, {from: artist});
            ...
            let listing = await this.fantomMarketplace.listings(this.nfthab.address, new BN('1'), artist);
            console.log(`
            ...
            *The wFTM balance of buyer now should be 30 wFTMs`);
            ...
            let nftOwner = await this.nfthab.ownerOf(new BN('1'));
            console.log(`
            ...
            *The wFTM balance of the artist should be 19 wFTMs`);
            ...
            listing = await this.fantomMarketplace.listings(this.nfthab.address, new BN('1'), artist);
            console.log(`
        ...
        it('Scenario 2', async function() {
            ...
            *Event Minted should be emitted with correct values: 
            ...
            console.log(`
            The artist approves the nft to the market`);
            await this.nfthab.setApprovalForAll(this.fantomAuction.address, true, {from: artist});
            ...
            *Event AuctionCreated should be emitted with correct values: 
            nftAddress = ${this.nfthab.address}, 
            tokenId = 1, 
            payToken = ${this.mockERC20.address}`);
            ...
            await this.fantomAuction.placeBid(this.nfthab.address, new BN('1'), ether('20'), { from: bidder1 });
            ...
            *Bidder1's wFTM balance after bidding should be 30 wFTMs`);
            ...
            await this.fantomAuction.placeBid(this.nfthab.address, new BN('1'), ether('25'), { from: bidder2 });
            ...
            *Bidder2's wFTM balance after bidding should be 25`);
            ...
            await this.fantomAuction.placeBid(this.nfthab.address, new BN('1'), ether('30'), { from: bidder3 });
            ...
            *Bidder3's wFTM balance after bidding should be 20`);
            ...
            result = await this.fantomAuction.resultAuction(this.nfthab.address, new BN('1'), {from : artist});
        ...
        it('Scenario 3', async function() {
            ...
            *Event Minted should be emitted with correct values: 
            ...
            result = await this.nfthab.mint(artist, 'http://artist.com/art2.jpeg', {from: artist, value: ether(PLATFORM_FEE)});
            console.log(`
            ...
            *The difference of the recipients's FTM balance should be ${PLATFORM_FEE*2} FTMs as the platform fee is ${PLATFORM_FEE} FTMs `);
            ...
            console.log(`
            The artist approves the nft to the market`);
            await this.nfthab.setApprovalForAll(this.fantomBundleMarketplace.address, true, {from: artist});
            ...
            await this.fantomBundleMarketplace.listItem(
                    'mynfts',
                    [this.nfthab.address, this.nfthab.address],
                    [new BN('1'),new BN('2')],
                    [new BN('1'), new BN('1')],
                    this.mockERC20.address,
                    ether('20'),
            ...
            *The nfts should be on the bundle marketplace listing`);
            ...
            expect(listing.nfts[0]).to.be.equal(this.nfthab.address);
            expect(listing.nfts[1]).to.be.equal(this.nfthab.address);
            ...
            *The two nfts now should belong to buyer`);
            let nftOwner = await this.nfthab.ownerOf(new BN('1'));
            expect(nftOwner).to.be.equal(buyer);
            nftOwner = await this.nfthab.ownerOf(new BN('2'));
            expect(nftOwner).to.be.equal(buyer);
